...
import { ArrowLeft, Command, Github, Chrome, TerminalSquare } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white flex w-full">
        ...
        <div className="relative z-10 space-y-8">
          ...
          >
            <div className="flex items-start gap-4">
              <TerminalSquare className="w-6 h-6 text-white/30 shrink-0" />
              <p className="font-medium text-sm text-white/70 leading-relaxed">
                Welcome back. Authentication required to access engineering resources, draft articles, and interact with the collective.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 bg-white overflow-y-auto">
        <div className="w-full max-w-md space-y-12">
          ...
          <div>
            <h2 className="text-3xl font-black text-primary tracking-tighter uppercase mb-2">Identify</h2>
          ...
          <form className="space-y-6">
            ...
            <div className="flex justify-end pt-2">
              <button type="button" className="font-mono text-[9px] font-black uppercase tracking-widest text-primary/30 hover:text-primary transition-colors">
                Recover Password
              </button>
            </div>
            ...
            <button className="w-full bg-primary text-white py-5 px-8 font-black text-xs uppercase tracking-[0.2em] hover:bg-black transition-colors flex justify-center items-center gap-3">
              Authorize <ArrowLeft className="w-4 h-4 rotate-180" />
            </button>
            
            <div className="flex items-center justify-center space-x-4 pt-6">
              <div className="h-[1px] flex-grow bg-primary/10" />
              <span className="font-mono text-[9px] font-black text-primary/30 uppercase tracking-[0.3em]">Or bypass with</span>
              <div className="h-[1px] flex-grow bg-primary/10" />
            </div>
